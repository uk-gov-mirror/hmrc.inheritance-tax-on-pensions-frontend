...
class NoNinoReasonController @Inject() (
  override val messagesApi: MessagesApi,
  allowAccess: AllowAccessActionWithSessionCacheProvider,
  identify: IdentifierAction,
  getData: DataRetrievalAction,
  requireData: DataRequiredAction,
  formProvider: NoNinoReasonFormProvider,
  val controllerComponents: MessagesControllerComponents,
  userAnswersService: UserAnswersService,
  view: NoNinoReasonView
    ...
    identify
      ...
      .andThen(requireData) { implicit request =>
        DeceasedNameHelper.withName(request.userAnswers)(
          ...
          val preparedForm = request.userAnswers.get(NoNinoReasonPage) match {
            case None => form
        ...
        DeceasedNameHelper.withName(request.userAnswers)(
          ...
          form
            ...
            .fold(
              ...
              value =>
                for {
                  updatedAnswers <- Future.fromTry(request.userAnswers.set(NoNinoReasonPage, value))
